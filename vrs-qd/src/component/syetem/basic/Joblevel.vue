<template>
	<div>
		bbb
		<div>
			<el-input v-model="jobLevel.name" placeholder="添加职称..." size="small" class="input_type" prefix-icon="el-icon-plus">
			</el-input>
		...
		<div style="margin-top: 8px">
			<el-table :data="jobLevels" stripe border type="mini" style="width: 80%" @selection-change="handleSelectionChange">
